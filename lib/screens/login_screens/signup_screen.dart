                  ...
                  children: [SizedBox(height: 100),
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text("DO IT ", style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25)),
                      ],
                    ),
                    Text("create an account and Join us now! ",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)
                    ),
                    SizedBox(height: 40),
                    TextFormField(
                      controller: name,
                    ...
                    TextFormField(
                      ...
                      validator: (value){
                        ...
                        if (!RegExp(r'^[A-Za-z]+[0-9]+@gmail\.com$').hasMatch(value)) {
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        if(_formKey.currentState!.validate()){
                          ...
                          //         Text('You gonna recieve a verification code in your email'),
                          //       ],
                          //     ),
                          //   );
                          // });
                        ...
                        try{
                          ...
                          await auth.currentUser!.updateDisplayName(name.text.toString());
                        ...
                        SizedBox(
                            height: 20,
                            width: 20,
                            child: CircularProgressIndicator(color: Colors.white,strokeWidth: 2,)) : Text("sign up"),
                      ),
                    ),
                    SizedBox(height: 20),
                      ...
                      children: [
                        ...
                        TextButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => SignInScreen()),);
                            ...
                            child: Text('sign in',style: TextStyle(color: Color(0xff0EA5E9),fontWeight: FontWeight.bold),))
                      ],
                    )
                  ],
                ),
